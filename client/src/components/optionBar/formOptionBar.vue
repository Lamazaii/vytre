...
// Layer dropdown local visibility state.
...
// Path for fill icon in the color picker.
...
// Path for stroke icon in the color picker.
...
// Open/close layer menu only when a shape is selected.
...
// Request one-step forward move for selected shape.
function onBringForwardMenuClick() {
  shapeStore.requestBringShapeForward()
  closeLayerMenu()
}

// Request one-step backward move for selected shape.
